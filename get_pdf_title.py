...
# taken from https://gist.github.com/hanjianwei/6838974 because apparently getting the title from a pdf without meta-data is painful
...
def copyright_line(line):
    ...
    return re.search(
        r"technical\s+report|proceedings|preprint|to\s+appear|submission", line.lower()
    )
